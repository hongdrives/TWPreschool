...
export const DEFAULT_EN: SiteContent = {
  site: { name:"Taiwan Preschool Exchange", tagline:"短期幼稚園交流", email:"contact@preschoolexchange.org", domain:"www.preschoolexchange.org", logo:"/assets/logo.png", heroBgOpacity:0.10, theme:'t1' },
  nav: {
...
export const DEFAULT_ZH: SiteContent = {
  site:{ name:"台灣幼兒交流", tagline:"Taiwan Preschool Exchange", email:"contact@preschoolexchange.org", domain:"www.preschoolexchange.org", defaultLang:"en", logo:"/assets/logo.png", heroBgOpacity:0.10, theme:'t1' },
  nav:{
